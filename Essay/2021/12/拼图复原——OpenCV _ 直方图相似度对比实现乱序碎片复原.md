...
### 结果演示
**碎片：**
![在这里插入图片描述](https://img-blog.csdnimg.cn/e10f976ba8fa458995223bfd9ec76735.png#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/1e15ac56afda4c598de75fbaca975d2b.png#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/887758d9b9c049b8940f3e4d5b11386e.png#pic_center)
![在这里插入图片描述](https://img-blog.csdnimg.cn/52241f85c744465fb7dd635c28328ee1.png#pic_center)
**拼接结果：**

![在这里插入图片描述](https://img-blog.csdnimg.cn/a407a3dc06d842fc87a83a6e00914ea5.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAV2ludGVyX2lz,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center)
**参考文章**
[OpenCV学习笔记——判断两张图的相似度](https://blog.csdn.net/qq_33548747/article/details/88089575)

*代码尚完善，还有些地方存在小bug（因为又菜又懒），如果在运行过程中报错就把直方图比对函数compare_by_hist()的返回值调小直到运行成功*

[项目地址](https://github.com/Zane-GL/Puzzle_restoration)
